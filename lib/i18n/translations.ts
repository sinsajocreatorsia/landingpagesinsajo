export const translations = {
  es: {
    ...
    pricing: {
      ...
      currentPrice: '$197',
      discount: '60% OFF',
      limitedTime: 'Precio especial por tiempo limitado',
      includes: 'Incluye',
      features: [
    ...
    // Footer
    footer: {
      description: 'Transformando empresarias exitosas en líderes tecnológicas con inteligencia artificial.',
  ...
  en: {
      ...
      phases: [
        {
          title: 'Manual Chaos',
          subtitle: 'UNFILTERED',
          description: 'From manual chaos to clarity. We identify friction points in your business.',
        },
        {
          title: 'Implementation Phase',
          subtitle: 'STREAMLINED',
    ...
    pricing: {
      ...
      subtitle: 'An investment that pays for itself in the first week of implementation.',
      originalPrice: '$497',
      currentPrice: '$197',
      discount: '60% OFF',
      limitedTime: 'Special price for limited time',
      includes: 'Includes',
      features: [
