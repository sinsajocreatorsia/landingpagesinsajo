...
export const paymentLimiter = new RateLimiter({ limit: 3, windowSec: 60 })
export const emailLimiter = new RateLimiter({ limit: 10, windowSec: 60 })
export const surveyLimiter = new RateLimiter({ limit: 3, windowSec: 60 })
