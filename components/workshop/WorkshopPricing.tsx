    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="animate-on-scroll transition-all duration-700 delay-200 bg-[#FCFEFB] rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
          ...
          {/* Limited spots badge - LAST SPOT */}
          <div className="flex justify-center mb-8">
            <div className="flex items-center gap-2 bg-red-100 border-2 border-red-400 rounded-full px-5 py-2.5 animate-pulse shadow-lg shadow-red-200/50">
              <span className="w-3 h-3 bg-red-500 rounded-full animate-ping" />
              <span className="text-red-700 font-bold text-sm tracking-wide">
                🔥 ¡ÚLTIMO LUGAR DISPONIBLE! — No dejes pasar esta oportunidad
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-8 pt-8 border-t border-gray-200">
            ...
            <div className="flex items-center gap-2 text-[#022133]/60">
              ...
              <span className="text-sm">¡Último cupo disponible!</span>
            </div>
            <div className="flex items-center gap-2 text-[#022133]/60">
