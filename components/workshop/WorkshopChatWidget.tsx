            ...
            <div className="bg-gradient-to-r from-[#C7517E] to-[#2CB6D7] p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">Asesora del Workshop</p>
                </div>
              </div>
              <button
            ...
            <form onSubmit={sendMessage} className="p-4 border-t border-[#2CB6D7]/20 bg-[#022133]">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-white/5 border border-[#2CB6D7]/30 rounded-full focus:outline-none focus:ring-2 focus:ring-[#C7517E] text-white placeholder-gray-400 text-sm"
                />
                <button
                  type="submit"
