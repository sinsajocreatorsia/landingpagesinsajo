...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: '¡Los 12 cupos se agotaron! Pero puedes unirte a la lista de espera para el próximo workshop. Este workshop es ultra-íntimo con un grupo muy reducido que permite una experiencia de aprendizaje personalizada, donde cada asistente recibe atención individual y puede resolver todas sus dudas en tiempo real.',
  },
  {
