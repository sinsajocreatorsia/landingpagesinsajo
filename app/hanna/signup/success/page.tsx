    ...
    >
      ...
      {isPro && (
        <motion.div
          ...
          className="bg-[#C7517E]/10 border border-[#C7517E]/30 rounded-xl px-4 py-3 mb-6 flex items-center gap-3"
        >
          <Crown className="w-5 h-5 text-[#C7517E] flex-shrink-0" />
          <p className="text-white/80 text-sm text-left">
            Después de confirmar tu email, serás redirigida al checkout para activar tu plan Pro ($19/mes).
          </p>
        </motion.div>
      )}
      ...
      <div className="bg-white/5 rounded-xl p-4 mb-6 text-left">
        ...
        <ul className="space-y-2 text-white/70 text-sm">
          ...
          <li className="flex items-start gap-2">
            ...
            {isPro ? 'Completa el pago de tu plan Pro' : 'Inicia sesión en Hanna'}
          </li>
          <li className="flex items-start gap-2">
...
export default function SignupSuccessPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#022133] via-[#0a2e47] to-[#200F5D] flex items-center justify-center p-4">
      <Suspense fallback={
        <div className="animate-pulse w-full max-w-md text-center">
          <div className="w-24 h-24 mx-auto mb-6 bg-white/20 rounded-full" />
          <div className="h-8 w-48 mx-auto mb-4 bg-white/20 rounded" />
